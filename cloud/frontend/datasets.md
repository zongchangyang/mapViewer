...
Flooded Vegetation, Mangroves, Shrubland, Grassland, and Snow/Ice. <a href="#" class="dataset-details-link" onclick="showSunstoneDetails();return false">&#9432; View class details</a>
...
updated with each new Sentinel-2 acquisition. <a href="#" class="dataset-details-link" onclick="showDynamicWorldDetails();return false">&#9432; View class details</a>
...
its utility for distinguishing semi-arid vegetation types. <a href="#" class="dataset-details-link" onclick="showEsriDetails();return false">&#9432; View class details</a>
...
products. Maps are available for 2020 and 2021. <a href="#" class="dataset-details-link" onclick="showWorldCoverDetails();return false">&#9432; View class details</a>
...
Somali Acacia-Commiphora bushlands and the East African mangroves. The layer
is included here for biogeographic context — it is not used as a label source
for the consensus pipeline. Colors and names follow the official RESOLVE
attribute table. <a href="#" class="dataset-details-link" onclick="showResolveEcoregionsDetails();return false">&#9432; View class details</a>
